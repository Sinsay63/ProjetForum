...
if(isset($_GET['ID_auteur']) && isset($_GET['ID'])){
        $repons = $bdd->query("select log.Pseudo, art.Titre, art.Contenu, art.Date_Publication,art.ID_auteur,art.ID from logins as log inner join articles as art on art.ID ='$id_art' and log.ID = '$id_aut'");
